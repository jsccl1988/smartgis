#include "legacy_render/gl/gl_3drenderdevice.h"
#include "base/core/logmanager.h"
#include "legacy_render/gl/gl_multitexturefuncimp.h"
#include "legacy_render/gl/gl_shaderfuncimp.h"
#include "legacy_render/gl/gl_vsyncfuncimp.h"
#include "legacy_render/gl/gl_mipmapfuncimp.h"
#include "legacy_render/gl/gl_vbofuncimp.h"
#include "legacy_render/gl/gl_fbofuncimp.h"
#include "legacy_render/gl/gl_text.h"
#include "legacy_render/render3d/texturemanager.h"
#include "legacy_render/render3d/programmanager.h"
#include "legacy_render/render3d/shadermanager.h"
...
namespace render
{
	...
	long SmtGLRenderDevice::Init(HWND hWnd,const char* logname)
	{
		...
		pLog->log_message("Init OpenGL 3DRenderDevice ok!");
