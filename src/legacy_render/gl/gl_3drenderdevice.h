...
Desc:    SmtGLRenderDevice,opengl ��ά��Ⱦ����
...
#include "legacy_render/gl/gl_statesmanager.h"

#include "legacy_render/gl/gl_shaderfunc.h"
#include "legacy_render/gl/gl_multitexturefunc.h"
#include "legacy_render/gl/gl_vsyncfunc.h"
#include "legacy_render/gl/gl_mipmapfunc.h"
#include "legacy_render/gl/gl_vbofunc.h"
#include "legacy_render/gl/gl_fbofunc.h"

#include "legacy_render/gl/gl_devicecaps.h"
//
namespace render
{
	#define MAX_LIGHTS 8
	...
	class RENDER_GL_EXPORT_CLASS SmtGLRenderDevice:public Smt3DRenderDevice
	{
	public:
