...
#include "legacy_render/render3d/3ddevicecaps.h"
...
#include "legacy_render/render3d/framebuffer.h"

#include "legacy_render/render3d/statesmanager.h"
...
namespace render
{
	...
	extern "C" 
	{
		RENDER3D_EXPORT_API HRESULT Create3DRenderDevice(HINSTANCE hDLL, Smt3DRenderDevice* & pInterface);
		typedef HRESULT (*_Create3DRenderDevice)(HINSTANCE hDLL, Smt3DRenderDevice* &pInterface);

		RENDER3D_EXPORT_API HRESULT Release3DRenderDevice(Smt3DRenderDevice* & pInterface);
