...
namespace render
{
	...
	protected:
		...
		bool					Create3DMultiPointVB(LP3DRENDERDEVICE p3DRenderDevice,OGRMultiPoint *p3DMultPoint);
		bool					Create3DLineStringVB(LP3DRENDERDEVICE p3DRenderDevice,OGRLineString *p3DLineString);
		bool					Create3DLinearRingVB(LP3DRENDERDEVICE p3DRenderDevice,OGRLinearRing *p3DLinearRing);
		bool					Create3DMultiLineStringVB(LP3DRENDERDEVICE p3DRenderDevice,OGRMultiLineString *p3DMultLinearRing);
