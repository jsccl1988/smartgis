...
namespace render
{
	...
	//////////////////////////////////////////////////////////////////////////
	bool Smt3DGeoObject::Create3DPointVB(LP3DRENDERDEVICE p3DRenderDevice,OGRPoint *p3DPoint)
	{
	...
	bool Smt3DGeoObject::Create3DMultiPointVB(LP3DRENDERDEVICE p3DRenderDevice,OGRMultiPoint *p3DMultPoint)
	{
	...
	bool Smt3DGeoObject::Create3DLineStringVB(LP3DRENDERDEVICE p3DRenderDevice,OGRLineString *p3DLineString)
	{
	...
	bool Smt3DGeoObject::Create3DLinearRingVB(LP3DRENDERDEVICE p3DRenderDevice,OGRLinearRing *p3DLinearRing)
	{
	...
	bool Smt3DGeoObject::Create3DMultiLineStringVB(LP3DRENDERDEVICE p3DRenderDevice,OGRMultiLineString *p3DMultLinearRing)
	{
		return true;
	}
	...
	{
		m_pVertexBuffer = p3DRenderDevice->CreateVertexBuffer(p3DSurf->get_point_count(),
		...
		m_pIndexBuffer = p3DRenderDevice->CreateIndexBuffer(p3DSurf->get_triangle_count()*3);
		m_pIndexBuffer->Lock();
	...
	bool Smt3DGeoObject::Render3DSurfaceVB(LP3DRENDERDEVICE p3DRenderDevice)
	{
		...
		p3DRenderDevice->DrawIndexedPrimitives(PT_TRIANGLELIST,m_pVertexBuffer,m_pIndexBuffer,0,p3DSurf->get_triangle_count());
