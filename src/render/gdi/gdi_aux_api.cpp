...
void DrawRect (HDC hDC,RECT &rect,BOOL  use_xor)
{
...
void DrawRect (HDC hDC,lRect &lrect,BOOL  use_xor)
{
...
void DrawLine(HDC hDC,Smt_Core::lPoint *plPoints,int nCount,BOOL  use_xor )
{
	if (plPoints == NULL)
		return;
...
void DrawLine(HDC hDC,POINT  *pPoints,int nCount,BOOL  use_xor)
{
	if (pPoints == NULL)
		return;
...
void DrawCross(HDC hDC,long lX,long lY,long r,BOOL  use_xor)
{
