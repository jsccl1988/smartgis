...
// Raster / child-image layer. Create is false unless the dataset already
// has GDAL raster bands; never invents an ADO geom_points blob table.
class OgrRasterLayer : public Smt_GIS::SmtRasterLayer {
 public:
