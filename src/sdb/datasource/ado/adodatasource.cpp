...
#include "dotfcls_adoveclayer.h"
#include "cldimgfcls_adoveclayer.h"
#include "annofcls_adoveclayer.h"
#include "curvefcls_adoveclayer.h"
#include "surfacefcls_adoveclayer.h"
#include "gridfcls_adoveclayer.h"
#include "tinfcls_adoveclayer.h"
...
namespace Smt_SDEAdo
{
   ...
   bool SmtAdoDataSource::IsTableExist(const char * szTableName)
   {
	   ...
	   while(!(m_SmtRecordset.IsEOF()))
	   {
		   ...
		   _variant_t table_var(
			   m_SmtRecordset.GetFields()->GetItem("TABLE_NAME")->Value);
		   _bstr_t table_name(table_var.bstrVal);
