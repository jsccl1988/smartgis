...
namespace ui
{
	...
	bool Smt2DEditXView::CreateTools(void)
	{
		...
		delete m_pMapEdits;
		m_pMapEdits = new sdb::MapEditSession(m_pSmtOperMap);
		...
		pLog->log_message("Init 2DEditView GroupTools OK!");
	...
	bool Smt2DEditXView::CreateContexMenu()
	{
		...
		pLog->log_message("Init 2DEditView ContexMenu OK!");
	...
	bool Smt2DEditXView::CreateMainMenu()
	{
		...
		pLog->log_message("Init 2DEditView MainMenu OK!");
