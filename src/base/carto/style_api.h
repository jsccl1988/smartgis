...
//////////////////////////////////////////////////////////////////////////
void STYLE_EXPORT viewport_to_rect(base::lRect &lrect,
                                   const base::Viewport &viewport);
void STYLE_EXPORT windowport_to_rect(base::fRect &frect,
                                     const base::Windowport &windowport);

void STYLE_EXPORT envelope_to_rect(base::fRect &frect,
                                   const base::Envelope &env);
void STYLE_EXPORT rect_to_envelope(base::Envelope &env,
                                   const base::fRect &frect);

void STYLE_EXPORT
anno_desc_to_log_font(LOGFONT &lf, const base::SmtAnnotationDesc &annoDesc);
void STYLE_EXPORT log_font_to_anno_desc(base::SmtAnnotationDesc &annoDesc,
                                        const LOGFONT &lf);
