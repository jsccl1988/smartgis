...
//////////////////////////////////////////////////////////////////////////
		...
		inline void						set_brush_desc(const SmtBrushDesc &brushDesc) {m_stBrushDesc = brushDesc;}
		inline void						set_anno_desc(const SmtAnnotationDesc &annoDesc) {m_stAnnoDesc = annoDesc;}
		inline void						set_symbol_desc(const SmtSymbolDesc &symbolDesc) {m_stSymbolDesc = symbolDesc;}
...
//////////////////////////////////////////////////////////////////////////
		...
		inline  const SmtBrushDesc		&get_brush_desc(void)  const { return m_stBrushDesc; }  
		inline  const SmtAnnotationDesc	&get_anno_desc(void)  const { return m_stAnnoDesc; }   
		inline  const SmtSymbolDesc		&get_symbol_desc(void)  const { return m_stSymbolDesc; }
