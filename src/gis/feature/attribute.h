...
// SmtAttribute / SmtField left //src/gis/map:gis. Product fields live on
// OGRFeature / OGRFeatureDefn (gis::Feature, MapLayer::ogr()).
// MFC leftover only: link //src/gis/feature:leftover_attr and define
// SMT_ALLOW_LEFTOVER_ATTRIBUTE before including this header.
#if !defined(SMT_ALLOW_LEFTOVER_ATTRIBUTE)
#error \
    "SmtAttribute/SmtField left //src/gis/map:gis. Use OGR field APIs. " \
    "Leftover: define SMT_ALLOW_LEFTOVER_ATTRIBUTE and link " \
    "//src/gis/feature:leftover_attr."
#endif

#include "base/core/bas_struct.h"
#include "base/core/core.h"
#include "gis/feature/leftover_attr_export.h"
