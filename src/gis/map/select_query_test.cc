...
int main() {
  ...
  gis::ScratchLayer box_hits = gis::DataSourceMgr::create_mem_vec_layer();
  ...
  gis::ScratchLayer flash = gis::DataSourceMgr::create_mem_vec_layer();
  ...
  gis::DataSourceMgr::destroy_mem_vec_layer(point_hits);
  gis::DataSourceMgr::destroy_mem_vec_layer(box_hits);
  gis::DataSourceMgr::destroy_mem_vec_layer(flash);
  GDALClose(ds);
