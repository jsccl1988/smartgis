...
bool OgrRasterLayer::Fetch(gis::eSmtFetchType /*type*/) { return IsOpen(); }

void OgrRasterLayer::CalEnvelope() { ::rect_to_envelope(m_lyrEnv, rect_); }
...
long OgrRasterLayer::GetRaster(char*& pRasterBuf, long& lRasterBufSize,
                               base::fRect& fLocRect, long& lImageCode) const {
  char* src = nullptr;
  long size = 0;
  base::fRect loc;
  long code = 0;
