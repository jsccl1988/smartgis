...
bool ProviderTileLayer::Fetch(eSmtFetchType /*type*/) { return m_bOpen; }
...
void ProviderTileLayer::MoveFirst() const { cursor_ = 0; }

void ProviderTileLayer::MoveNext() const { ++cursor_; }
