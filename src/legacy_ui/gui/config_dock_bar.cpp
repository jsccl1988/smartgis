...
#include "stdafx.h"
#include "legacy_ui/gui/config_dock_bar.h"
...
static const char* lpszTrueOrFalse [] = 
{
	"False",
	"True",	
	NULL
...
LRESULT SysConfigDockBar::OnPropertyChanged (WPARAM,LPARAM lParam)
{
	...
	case PRO_FLASH_CLR1:
		{
			SmtStyle *pDotFlashStyle1 = pStyleMgr->get_style(styleConfig.szDotFlashStyle1);
			SmtStyle *pLineFlashStyle1 = pStyleMgr->get_style(styleConfig.szLineFlashStyle1);
			SmtStyle *pRegionFlashStyle1 = pStyleMgr->get_style(styleConfig.szRegionFlashStyle1);

			SmtStyle *pDotFlashStyle2 = pStyleMgr->get_style(styleConfig.szDotFlashStyle2);
			SmtStyle *pLineFlashStyle2 = pStyleMgr->get_style(styleConfig.szLineFlashStyle2);
			SmtStyle *pRegionFlashStyle2 = pStyleMgr->get_style(styleConfig.szRegionFlashStyle2);
