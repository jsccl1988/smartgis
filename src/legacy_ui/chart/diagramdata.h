...
namespace ui
{
	...
	public:
		// Vector chart layers are OGR (MapLayer::from_ogr); do not return leftover SmtLayer*.
		OGRLayer*					CreateLayer(const char *szName,fRect &lyrRect,SmtFeatureType ftType = SmtFeatureType::SmtFtDot);
