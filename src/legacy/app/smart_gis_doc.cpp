// SmartGisDoc.cpp : CSmartGisDoc 缁祽鍒婇惃璇垔鐎硅鍒婇悳?//
...
{
	// TODO: 閸︺劍顒濊偀顖涚潱鑲燁垰濞婃稉鈧▎鈩冣偓褖鍒婇弸绛嬬炊鏀典京鍒婃禍鐣岀垳
	m_hCurMainMenu = NULL;
}
...
BOOL CSmartGisDoc::OnNewDocument()
{
	...
	// TODO: 閸︺劍顒濊偀顖涚潱鑲燁垰濞婇柌宥嬪垔閺傝棄鍨佃偀顖氼瀴閸栨牤鍒婃禍鐣岀垳
...
void CSmartGisDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
		// TODO: 閸︺劍顒濊偀顖涚潱鑲燁垰濞婄€涙﹤鍒婇崒璇垔娴滅晫锟?
	}
	else
	{
		// TODO: load code
