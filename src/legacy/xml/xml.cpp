...
bool TiXmlDocument::LoadFile(FILE* file, TiXmlEncoding encoding) {
  ...
  */
  ...
  //		* LF:    Multics, Unix and Unix-like systems (GNU/Linux, AIX, Xenix, Mac
  // OS X, FreeBSD, etc.), BeOS, Amiga, RISC OS, and others
  //		* CR+LF: DEC RT-11 and most other early non-Unix, non-IBM OSes, CP/M,
  // MP/M, DOS, OS/2, Microsoft Windows, Symbian OS
  //		* CR:    Commodore 8-bit machines, Apple II family, Mac OS up to version
  // 9 and OS-9
