...
class Smt3DRenderDevice {
 ...
 public:
  ...
  virtual long DrawText(uint unID, float xpos, float ypos, float zpos,
                        const SmtColor &color, const char *, ...) = 0;
 ...
 public:
  ...
  // fog stuff
  virtual long SetFog(FogMode mode, const SmtColor &colour, float density,
                      float start, float end) = 0;

 public:
  //////////////////////////////////////////////////////////////////////////vbuf
  // vertex buffer
  virtual SmtVertexBuffer *CreateVertexBuffer(int nCount, ulong unFormat,
  ...
  virtual long SetProgramVertexShader(SmtProgram *program,
                                      SmtShader *shader) = 0;
  virtual long SetProgramPixelShader(SmtProgram *program,
                                     SmtShader *shader) = 0;
  ...
  virtual long SetProgramFloat(SmtProgram *program, string &param,
                               float value) = 0;
