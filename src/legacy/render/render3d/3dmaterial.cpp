...
// get
const SmtColor& SmtMaterial::GetDiffuseValue(void) { return m_cDiffuse; }

const SmtColor& SmtMaterial::GetSpecularValue(void) { return m_cSpecular; }

const SmtColor& SmtMaterial::GetAmbientValue(void) { return m_cAmbient; }

const SmtColor& SmtMaterial::GetEmissiveValue(void) { return m_cEmissive; }

float SmtMaterial::GetShininessValue(void) { return m_fShininess; }
