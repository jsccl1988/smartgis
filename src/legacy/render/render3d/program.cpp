...
namespace render {
SmtProgram::SmtProgram(LP3DRENDERDEVICE p3DRenderDevice, uint handle,
                       string strName)
    : m_unHandle(handle),
...
long SmtProgram::Use() { return m_p3DRenderDevice->BindProgram(this); }

long SmtProgram::Unuse() { return m_p3DRenderDevice->UnbindProgram(); }
...
long SmtProgram::IsLinked() { return m_p3DRenderDevice->IsProgramLinked(this); }
