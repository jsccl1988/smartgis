#include "legacy/render/gdi_simple/gdi_renderbuf.h"
...
namespace render {
SmtRenderBuf::SmtRenderBuf(HWND hWnd) : m_hWnd(hWnd), m_bOnwerBuf(true) {}

SmtRenderBuf::SmtRenderBuf(void) : m_hWnd(NULL), m_bOnwerBuf(true) {}
...
long SmtRenderBuf::SetBufSize(int cx, int cy) {
  ...
  ClearBuf(0, 0, m_nBufWidth,
           m_nBufHeight /*,(COLORREF)::GetSysColor(COLOR_WINDOW)*/);
