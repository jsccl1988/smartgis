/*
File:    gdi_simplerenderdevice.h

Desc:    SmtGdiSimpleRenderDevice,GDI ��ͼ��Ⱦ������
     1.��Ⱦ�㣺	Direct ֱ����DC�ϻ��ƣ�������פ��������ˢ��֮������ʧ
          Map
...
*/
#ifndef _GDI_SIMPLERENDERDEVICE_H
#define _GDI_SIMPLERENDERDEVICE_H
...
#include "legacy/render/gdi_simple/gdi_bufpool.h"
...
namespace render {
class SmtGdiSimpleRenderDevice : public SmtRenderDevice {
 public:
  SmtGdiSimpleRenderDevice(HINSTANCE hInst);
  virtual ~SmtGdiSimpleRenderDevice(void);
 ...
 public:
  ...
  int RenderMap(const SmtMap *pMap, int x, int y, int w, int h,
                int op = R2_COPYPEN);
...
#endif  //_GDI_SIMPLERENDERDEVICE_H