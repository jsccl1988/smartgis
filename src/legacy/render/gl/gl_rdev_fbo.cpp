...
SmtRenderBuffer *SmtGLRenderDevice::CreateRenderBuffer(TextureFormat format,
                                                       uint width,
                                                       uint height) {
  GLhandleARB handle;
  ...
  SmtRenderBuffer *pRenderBuf =
      new SmtRenderBuffer(this, handle, format, width, height);
...
long SmtGLRenderDevice::AttachRenderBuffer(SmtFrameBuffer *frameBuffer,
...
long SmtGLRenderDevice::AttachTexture(SmtFrameBuffer *frameBuffer,
