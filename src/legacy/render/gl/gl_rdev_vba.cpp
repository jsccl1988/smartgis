...
namespace render {
SmtVertexBuffer* SmtGLRenderDevice::CreateVertexBuffer(int nCount,
                                                       DWORD dwFormat,
                                                       bool bDynamic) {
...
// vba
long SmtGLRenderDevice::SetVertexArray(int components, Type type, int stride,
                                       void* data) {
...
long SmtGLRenderDevice::SetTextureCoordsArray(int components, Type type,
