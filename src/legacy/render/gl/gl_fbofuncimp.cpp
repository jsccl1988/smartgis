#include "legacy/render/gl/gl_fbofuncimp.h"
...
void SmtFBOFuncImpl::glRenderbufferStorage(GLenum target, GLenum internalFormat,
                                           GLsizei width, GLsizei height) {
  _glRenderbufferStorage(target, internalFormat, width, height);
}

void SmtFBOFuncImpl::glFramebufferRenderbuffer(GLenum target, GLenum attachment,
...
void SmtFBOFuncImpl::glFramebufferTexture1D(GLenum target, GLenum attachment,
                                            GLenum texTarget, GLuint texId,
                                            int level) {
  _glFramebufferTexture1D(target, attachment, texTarget, texId, level);
}

void SmtFBOFuncImpl::glFramebufferTexture2D(GLenum target, GLenum attachment,
                                            GLenum texTarget, GLuint texId,
                                            int level) {
  _glFramebufferTexture2D(target, attachment, texTarget, texId, level);
}

void SmtFBOFuncImpl::glFramebufferTexture3D(GLenum target, GLenum attachment,
                                            GLenum texTarget, GLuint texId,
