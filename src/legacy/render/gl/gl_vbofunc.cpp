...
void SmtVBOFunc::glBufferData(GLenum target, GLsizeiptr size, GLvoid *data,
                              GLenum method) {
  ;
}

void *SmtVBOFunc::glMapBuffer(GLenum target, GLenum access) { return NULL; }

GLboolean SmtVBOFunc::glUnmapBuffer(GLenum target) { return GL_FALSE; }

void SmtVBOFunc::glGetBufferParameteriv(GLenum target, GLenum param,
                                        GLint *value) {
  ;
}
