...
// set fog
long SmtGLRenderDevice::SetFog(FogMode mode, const SmtColor &col, float density,
...
long SmtGLRenderDevice::SetShadeMode(RenderStateValue rsv, float f,
                                     const SmtColor &clr) {
