...
namespace render
{
	...
	long SmtTerrain::Create(LP3DRENDERDEVICE p3DRenderDevice)
	{
		...
		m_pVertexBuffer = p3DRenderDevice->CreateVertexBuffer(m_p3DSurf->get_point_count(),
		...
		m_pIndexBuffer = p3DRenderDevice->CreateIndexBuffer(m_p3DSurf->get_triangle_count()*3);
		m_pIndexBuffer->Lock();
