...
*****************************************************************************/
#if !defined( \
    AFX_GRIDBTNCELLCOMBO_H__00C20283_F376_11D3_B761_00C04F6A7AE6__INCLUDED_)
...
class AFX_EXT_CLASS CGridBtnCellCombo : public CGridBtnCell {
 ...
 public:
  ...
  // accessors
 public:
  virtual void SetComboStyle(DWORD dwComboStyle) {
    m_dwComboStyle = dwComboStyle;
  }
  virtual DWORD GetComboStyle() { return m_dwComboStyle; }

  virtual void SetComboString(const CStringArray& astrAry) {
    m_StringArrayCombo.Copy(astrAry);
  }
  virtual void GetComboString(CStringArray* apstrAry) {
    apstrAry->Copy(m_StringArrayCombo);
  }
