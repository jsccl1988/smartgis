// grid_cell_date_time.h: interface for the CGridCellDateTime class.
//
...
#if !defined( \
    AFX_DATETIMECELL_H__A0B7DA0A_0AFE_4D28_A00E_846C96D7507A__INCLUDED_)
...
class CInPlaceDateTime : public CDateTimeCtrl {
 ...
 public:
  CInPlaceDateTime(CWnd* pParent,          // parent
                   ...
                   COLORREF crFore,
                   COLORREF crBack,  // Foreground, background colour
                   CTime* pcTime,
