...
#if !defined( \
    AFX_GRIDCELLBASE_H__519FA702_722C_11D1_ABBA_00A0243D1382__INCLUDED_)
...
#define GVIF_ALL                                                   \
  (GVIF_TEXT | GVIF_IMAGE | GVIF_PARAM | GVIF_STATE | GVIF_BKCLR | \
   GVIF_FGCLR | GVIF_FORMAT | GVIF_FONT | GVIF_MARGIN)
...
// since we will usually have acces to them in other ways, and they are an extra
// 8 bytes per cell that is probably unnecessary.
...
class AFX_EXT_CLASS CGridCellBase : public CObject {
 ...
 public:
  ...
  virtual LPARAM GetData() const { return NULL; }
  ...
  virtual CFont* GetFontObject() const { return NULL; }
  ...
  virtual BOOL IsEditing() const { return TRUE; }
