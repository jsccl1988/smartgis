...
class STAT_CHART_EXPORT SmtChart : public SmtDiagramData {
 ...
 public:
  ...
  void SetXAxis(const char *szTitle, const char *szUnit) {
    m_cXAxis.strTitle = szTitle;
    m_cXAxis.strUnit = szUnit;
  }
  void SetYAxis(const char *szTitle, const char *szUnit) {
    m_cYAxis.strTitle = szTitle;
    m_cYAxis.strUnit = szUnit;
  }
