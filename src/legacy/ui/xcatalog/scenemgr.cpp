...
void SmtSceneMgr::DestoryInstance(void) { SMT_SAFE_DELETE(m_pSingleton); }

//////////////////////////////////////////////////////////////////////////
SmtSceneMgr::SmtSceneMgr(void) { m_pScene = NULL; }
...
//////////////////////////////////////////////////////////////////////////
SmtScene* SmtSceneMgr::GetScenePtr(void) { return m_pScene; }

const SmtScene* SmtSceneMgr::GetScenePtr(void) const { return m_pScene; }

SmtScene& SmtSceneMgr::GetScene(void) { return *m_pScene; }

const SmtScene& SmtSceneMgr::GetScene(void) const { return *m_pScene; }
...
bool SmtSceneMgr::Update3DXView(void) { return true; }

//////////////////////////////////////////////////////////////////////////
bool SmtSceneMgr::Register3DObjCatalog(void* p3DObjCatalog) {
  vector<void*>::iterator iter;
  iter = find(m_v3DObjCatalogPtrs.begin(), m_v3DObjCatalogPtrs.end(),
              p3DObjCatalog);
...
void SmtSceneMgr::CreateOctTreeSceneMgr(void) {
  if (m_pScene) return m_pScene->CreateOctTreeSceneMgr();
}
...
Smt3DObject* SmtSceneMgr::Get3DObject(int index) {
  if (m_pScene) return m_pScene->Get3DObject(index);

  return NULL;
}

void SmtSceneMgr::Get3DObjectPtrs(vSmt3DObjectPtrs& v3DObjectPtrs) {
  if (m_pScene) m_pScene->Get3DObjectPtrs(v3DObjectPtrs);
}
}  // namespace ui