...
static const char *lpszLineStyles[] = {"SOLID",   "-------", ".......",
                                       "_._._._", "_.._.._", NULL};

static const char *lpszRegFillStyles[] = {"SOLID", "Hatch", NULL};
...
bool EditConfigDockBar::CreateProList() {
  ...
  */
  ...
  if (pStyle) {
    ...
    CBCGPProp *pProp =
        new CBCGPProp(_T("Line Style"), (_variant_t)(lpszLineStyles[0]),
  ...
  if (pStyle) {
    ...
    CBCGPProp *pFillProp =
        new CBCGPProp(_T("Reg Fill Style"), (_variant_t)(lpszRegFillStyles[0]),
    ...
    CBCGPProp *pHatchProp = new CBCGPProp(
        _T("Hatch Style"), (_variant_t)(lpszRegFillHatchStyles[0]),
