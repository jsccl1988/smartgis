...
static const char *lpszTrueOrFalse[] = {"False", "True", NULL};
...
bool SysConfigDockBar::CreateProList() {
...

  {
    ...
    CBCGPProp *pProp =
        new CBCGPProp(_T("Show MBR"), (_variant_t)(lpszTrueOrFalse[index]),
...

  {
    ...
    CBCGPProp *pProp =
        new CBCGPProp(_T("Show Point"), (_variant_t)(lpszTrueOrFalse[index]),
...
LRESULT SysConfigDockBar::OnPropertyChanged(WPARAM, LPARAM lParam) {
  ...
  switch ((int)pProp->GetData()) {
    case PRO_FLASH_CLR1: {
      SmtStyle *pDotFlashStyle1 =
          pStyleMgr->get_style(styleConfig.szDotFlashStyle1);
      SmtStyle *pLineFlashStyle1 =
          pStyleMgr->get_style(styleConfig.szLineFlashStyle1);
      SmtStyle *pRegionFlashStyle1 =
          pStyleMgr->get_style(styleConfig.szRegionFlashStyle1);

      SmtStyle *pDotFlashStyle2 =
          pStyleMgr->get_style(styleConfig.szDotFlashStyle2);
      SmtStyle *pLineFlashStyle2 =
          pStyleMgr->get_style(styleConfig.szLineFlashStyle2);
      SmtStyle *pRegionFlashStyle2 =
          pStyleMgr->get_style(styleConfig.szRegionFlashStyle2);

      CBCGPColorProp *pClrProp = (CBCGPColorProp *)pProp;
      sysPra.flashPra.lClr1 = pClrProp->GetColor();

      pDotFlashStyle1->get_pen_desc().lPenColor = sysPra.flashPra.lClr1;
      pLineFlashStyle1->get_pen_desc().lPenColor = sysPra.flashPra.lClr1;
      pRegionFlashStyle1->get_pen_desc().lPenColor = sysPra.flashPra.lClr1;

      pDotFlashStyle2->get_brush_desc().lBrushColor = sysPra.flashPra.lClr1;
      pLineFlashStyle2->get_brush_desc().lBrushColor = sysPra.flashPra.lClr1;
      pRegionFlashStyle2->get_brush_desc().lBrushColor = sysPra.flashPra.lClr1;
    } break;
    case PRO_FLASH_CLR2: {
      SmtStyle *pDotFlashStyle1 =
          pStyleMgr->get_style(styleConfig.szDotFlashStyle1);
      ...
      pDotFlashStyle1->get_brush_desc().lBrushColor = sysPra.flashPra.lClr2;
      pLineFlashStyle1->get_brush_desc().lBrushColor = sysPra.flashPra.lClr2;
      pRegionFlashStyle1->get_brush_desc().lBrushColor = sysPra.flashPra.lClr2;

      pDotFlashStyle2->get_pen_desc().lPenColor = sysPra.flashPra.lClr2;
      pLineFlashStyle2->get_pen_desc().lPenColor = sysPra.flashPra.lClr2;
      pRegionFlashStyle2->get_pen_desc().lPenColor = sysPra.flashPra.lClr2;
    } break;
    case PRO_FLASH_ELAPSE: {
      sysPra.flashPra.lElapse = bcg_prop_as_long(pProp->GetValue());
    } break;
    case PRO_2DVIEW_SMARGIN: {
      sysPra.fSmargin = bcg_prop_as_float(pProp->GetValue());
    } break;
    case PRO_2DVIEW_ZOOMSCALEDELT: {
      sysPra.fZoomScaleDelt = bcg_prop_as_float(pProp->GetValue());
    } break;
    ...
    case PRO_2DVIEW_POINTRADUIS: {
      sysPra.lPointRaduis = bcg_prop_as_long(pProp->GetValue());
    } break;
    case PRO_3DVIEW_CLEARCOLOR: {
      sysPra.l3DViewClearColor = bcg_prop_as_long(pProp->GetValue());
    } break;
  }
