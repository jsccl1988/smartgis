...
namespace tool
{
	...
	int SmtSelectTool::Init(LPRENDERDEVICE pMrdRenderDevice,SmtMap *pOperSmtMap,HWND hWnd,pfnToolCallBack pfnCallBack,void* pToFollow)
	{
		...
		append_func_items("Rect Select",GT_MSG_SELECT_RECTSEL,FIM_2DVIEW|FIM_2DMFMENU);
		append_func_items("Polygon Select",GT_MSG_SELECT_POLYGONSEL,FIM_2DVIEW|FIM_2DMFMENU);
		append_func_items("Clear Selection",GT_MSG_SELECT_CLEAR,FIM_2DVIEW|FIM_2DMFMENU);
