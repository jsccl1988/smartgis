...
| [`superpowers/specs/2026-09-13-base-ipc-mojom-design.md`](superpowers/specs/2026-09-13-base-ipc-mojom-design.md) | C++23 + Chromium Mojo/mojom 跨进程地图（`MapContents`） |
