...
| `//src/ui/chart:stat_chart` | Moved MFC chart DLL `SmtStaDiagram` | stat, xview |
...
| `SmtStaDiagram` | `//src/algorithm/chart:stat_chart` | `//src/ui/chart:stat_chart` | `SmtStaDiagram` |
