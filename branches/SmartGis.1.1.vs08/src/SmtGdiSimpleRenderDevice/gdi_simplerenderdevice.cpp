...
namespace Smt_Rd
{
	...
	int SmtGdiSimpleRenderDevice::RenderLayer(const SmtVectorLayer *pLayer,int op)
	{
		if (NULL == pLayer)
			return SMT_ERR_INVALID_PARAM;
	...
	int SmtGdiSimpleRenderDevice::RenderFeature(const SmtFeature *pFeature,int op)
	{
		if (NULL == pFeature)
			return SMT_ERR_INVALID_PARAM;
